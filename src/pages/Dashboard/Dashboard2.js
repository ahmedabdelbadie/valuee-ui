  ...
  return (
    <Sec>
      <DataCard>
        <h3>270</h3>
        <h4>Sales Today</h4>
        <p> -2.65% Less sales than usual</p>
      </DataCard>
    </Sec>
  );
};
...
const Dashboard = () => {
  useEffect(() => {
    let chartStatus = Chart.getChart("canvas2"); // <canvas> id
    if (chartStatus != undefined) {
      chartStatus.destroy();
    }
    const nation = ChartGeo.topojson.feature(us, us.objects.nation).features[0];
    const states = ChartGeo.topojson.feature(us, us.objects.states).features;
    new ChoroplethChart(document.getElementById("canvas2").getContext("2d"), {
      data: {
